...
COS_API_KEY_ID="9EzGERne332uOjbmmARmp_sAT__3iuE6bAqKajo7K0Dt"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/3fed98193fbd4b2094d911e5f3fc17b1:b9431326-8c03-4492-ba9e-1bb534cdc8b4:bucket:lghproject"
...
@app.route('/')
def index():
    files = get_bucket_contents('lghproject')
